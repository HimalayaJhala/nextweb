...
const YourComponent = () => {
  ...
  useEffect(() => {
    ...
    if (isMobile) {
      ...
      mobileTl.to(imageRef.current, { yoyo: true, y: 180, duration: 9  ,delay: 0.7, top : 100 ,ease: 'power10.inOut'});
      const para = gsap.to(paraRef.current, { yoyo: true, y : -100 ,duration: 9, delay: 0.7, opacity: 1 });
