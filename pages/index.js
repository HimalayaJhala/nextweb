...
const YourComponent = () => {
  ...
  useEffect(() => {
    ...
    if (isMobile) {
      ...
      mobileTl.to(imageRef.current, { yoyo: true, y: 200, duration: 4  ,delay: .4, opacity :1 , top : 100 });
      const para = gsap.to(paraRef.current, { yoyo: true, y : -100 ,duration: 4, delay: .4, opacity: 1 });
