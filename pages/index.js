...
const YourComponent = () => {
  ...
  useEffect(() => {
    ...
    if (isMobile) {
      ...
      mobileTl.to(imageRef.current, { yoyo: true, y: 190, duration: 6.5  ,delay: 2, top : 100 ,ease: 'power3.inOut'});
      const para = gsap.to(paraRef.current, { yoyo: true, y : -80 ,duration: 6.5, delay: 2, opacity: 1 });
