...
const YourComponent = () => {
  ...
  useEffect(() => {
    ...
    if (isMobile) {
      ...
      mobileTl.to(imageRef.current, { yoyo: true, y: 200, duration: 9  ,delay: 2.5, top : 100 });
      const para = gsap.to(paraRef.current, { yoyo: true, y : -100 ,duration: 5, delay: 1.5, opacity: 0.9 });
