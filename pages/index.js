...
const YourComponent = () => {
  ...
  useEffect(() => {
    ...
    if (isMobile) {
      ...
      mobileTl.to(imageRef.current, { yoyo: true, y: 190, duration: 8  ,delay: 2, top : 100 });
      const para = gsap.to(paraRef.current, { yoyo: true, y : -100 ,duration: 8, delay: 2, opacity: 1 });
